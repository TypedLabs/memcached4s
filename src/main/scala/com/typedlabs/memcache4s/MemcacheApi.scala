...
// import com.typedlabs.memcached4s.Done
...
case class MemcacheApi(client: MemcachedClient, namespace: String, hashkeys: String = "off", throwExceptionFromGetOnError: Boolean = false)(implicit context: ExecutionContext) extends LazyLogging{
